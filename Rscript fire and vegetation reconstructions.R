...
test36 = bin_cor(FS, Larix, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Larix")
...
test9 = bin_cor(TEMP, Larix, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Larix")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Larix, bin_ts1, bin_ts2, "TEMP", "Larix", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test37 = bin_cor(RegFF, Cyperaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Cyperaceae")
...
test38 = bin_cor(RegBB, Cyperaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Cyperaceae")
...
test39 = bin_cor(FS, Cyperaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Cyperaceae")
...
test9 = bin_cor(TEMP, Cyperaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Cyperaceae")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Cyperaceae, bin_ts1, bin_ts2, "TEMP", "Cyperaceae", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test40 = bin_cor(RegFF, Ericaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Ericaceae")
...
test41 = bin_cor(RegBB, Ericaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Ericaceae")
...
test42 = bin_cor(FS, Ericaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Ericaceae")
...
test9 = bin_cor(TEMP, Ericaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Ericaceae")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Ericaceae, bin_ts1, bin_ts2, "TEMP", "Ericaceae", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test43 = bin_cor(RegFF, Artemisia, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Artemisia")
...
test44 = bin_cor(RegBB, Artemisia, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Artemisia")
...
test45 = bin_cor(FS, Artemisia, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Artemisia")
...
test9 = bin_cor(TEMP, Artemisia, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Artemisia")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Artemisia, bin_ts1, bin_ts2, "TEMP", "Artemisia", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test46 = bin_cor(RegFF, Poaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Poaceae")
...
test47 = bin_cor(RegBB, Poaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Poaceae")
...
test48 = bin_cor(FS, Poaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Poaceae")
...
test9 = bin_cor(TEMP, Poaceae, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Poaceae")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Poaceae, bin_ts1, bin_ts2, "TEMP", "Poaceae", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test49 = bin_cor(RegFF, Pediastrum, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Pediastrum")
...
test50 = bin_cor(RegBB, Pediastrum, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Pediastrum")
...
test51 = bin_cor(FS, Pediastrum, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Pediastrum")
...
test9 = bin_cor(TEMP, Pediastrum, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Pediastrum")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Pediastrum, bin_ts1, bin_ts2, "TEMP", "Pediastrum", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test52 = bin_cor(RegFF, Potamogeton, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Potamogeton")
...
test53 = bin_cor(RegBB, Potamogeton, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Potamogeton")
...
test54 = bin_cor(FS, Potamogeton, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Potamogeton")
...
test9 = bin_cor(TEMP, Potamogeton, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Potamogeton")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Potamogeton, bin_ts1, bin_ts2, "TEMP", "Potamogeton", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test55 = bin_cor(RegFF, Nuphar, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Nuphar")
...
test56 = bin_cor(RegBB, Nuphar, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Nuphar")
...
test57 = bin_cor(FS, Nuphar, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Nuphar")
...
test9 = bin_cor(TEMP, Nuphar, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Nuphar")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Nuphar, bin_ts1, bin_ts2, "TEMP", "Nuphar", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

test58 = bin_cor(RegFF, Alnus.r, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegFF_Alnusr")
...
test59 = bin_cor(RegBB, Alnus.r, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_RegBB_Alnusr")
...
test60 = bin_cor(FS, Alnus.r, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_FS_Alnusr")
...
test9 = bin_cor(TEMP, Alnus.r, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_TEMP_Alnusr")
binnedts      <- test9$Binned_time_series
bin_ts1 <- na.omit(test9$Binned_time_series[,1:2])
bin_ts2 <- na.omit(test9$Binned_time_series[,c(1,3)])
plot_ts(TEMP, Alnus.r, bin_ts1, bin_ts2, "TEMP", "Alnus.r", colts1=1, colts2=2, colbints1=3, colbints2=4, device="screen")
cor_ts(bin_ts1, bin_ts2, rmltrd="n", KoCM="pearson")

#TEMP vs PAR

test61 = bin_cor(TEMP, PAR, FLAGTAU=3, ofilename="F:/1-THESE/AXE_2_FEUX_PASSES/Github/Research-data-master/tmp/ccf_temp_par")
